...
import com.jp.app.databinding.NavFiveFragmentBinding
import com.jp.app.ui.navigation.viewModel.NavViewModel

class NavFragment5 : BaseFragment<NavFiveFragmentBinding, NavFragment5.FragmentCallback>() {

    val LAYOUT_ID = R.layout.nav_five_fragment
    private var mNavViewModel: NavViewModel? = null

    companion object {
        fun newInstance(bundle: Bundle?) = NavFragment5().apply {
