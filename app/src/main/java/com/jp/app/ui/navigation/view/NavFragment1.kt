...
import com.jp.app.databinding.NavOneFragmentBinding
import com.jp.app.ui.navigation.viewModel.NavViewModel

class NavFragment1 : BaseFragment<NavOneFragmentBinding, NavFragment1.FragmentCallback>() {

    val LAYOUT_ID = R.layout.nav_one_fragment

    private var mNavViewModel: NavViewModel? = null

    companion object {
        fun newInstance(bundle: Bundle?) = NavFragment1().apply {
